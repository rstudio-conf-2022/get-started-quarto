...
::: {style="font-size: 160px; text-align: center;" auto-animate="true" auto-animate-easing="ease-in-out"}
IMPORTANT POINT!
:::

##  

::: {style="font-size: 25px;" auto-animate="true" auto-animate-easing="ease-in-out"}
