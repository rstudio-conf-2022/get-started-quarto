...
-   Add some code to generate a basic plot using either the `palmerpenguins` dataset or `mtcars`
...
-   Explore the code
-   Add a new slide with a set of fragments
-   Render it!
...
# Code {background-image="https://data.nssmag.com/images/galleries/18043/code-matrix.jpg" background-size="cover"}
