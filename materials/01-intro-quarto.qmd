...
- Are you on the [latest version of Quarto](https://quarto.org/docs/get-started/) (`v1.0.15` or greater)?
...
Here is an example of a Lua filter that converts strong emphasis to small caps, from [https://pandoc.org/lua-filters.html](https://pandoc.org/lua-filters.html)
...
<h1 style='color:black;background-color: rgba(255,255,255,0.85);padding:5px;line-height:2em; text-align: center; position: absolute; top: 40%; width: 100%;'>Ease of Use VS Full Details</h1>
