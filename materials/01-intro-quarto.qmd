...
-   You can remove your mask to briefly drink/eat during breaks but please refrain from removing your mask in the workshop room itself
...
![](https://themockup.blog/images/profile-preview.png){height="650px"}
...
### Isabel Zimmerman - RStudio + TidyModels
...
-   Are you on the [latest version of Quarto](https://quarto.org/docs/get-started/) (preview `v1.0.32` or `v1.0`)?
...
-   Red = Tom isn't explaining it well enough or I need time

-   Green = I have completed the "Our Turn"

-   Raised hand = I have a question for Tom/TA - please try and make eye-contact with me or the TA, based on need
...
``` bash
quarto render FILE-NAME.qmd --to html
```

. . .

RStudio IDE \> Render button

![](https://quarto.org/docs/tools/images/rstudio-preview.png){height="800px"}
...
-   In RStudio, create a new blank document via the File Pane
-   In RStudio, open the integrated Terminal:
