...
-   Are you on the [latest version of Quarto](https://quarto.org/docs/get-started/) (preview `v1.0.35` or `v1.0`)?
...
- Render the new document via terminal with `quarto render DOCUMENT-NAME.QMD`
