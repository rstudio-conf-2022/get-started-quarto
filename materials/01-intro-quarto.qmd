...
- Got to <https://slido.com> and use code: `#start-quarto`
- Or use this direct link <https://app.sli.do/event/8QAGYPG5wgYFJBEtktoeFN>
...
- Join or chat for rstudio::conf 2022 virtually: <https://www.rstudio.com/blog/rstudio-conf-2022-virtual/>
- Watch live stream of talks on day of conference: <https://www.rstudio.com/conference/>
- The "Lounge" - a friendly place to talk with Open Source team, Academy/RStudio Cloud, or talk "Data Science at Work"
- Conference registration desk - a general catch-all for guidance
...
- Go to <https://slido.com> and use code: `#start-quarto`
- Or use this direct link <https://app.sli.do/event/8QAGYPG5wgYFJBEtktoeFN>
