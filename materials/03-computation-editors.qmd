...
- In a blank Quarto doc:
  - Insert a code chunk
  - Load `tidyverse` and `palmerpenguins`
  - Use some `tidyverse` code to explore the `palmerpenguins::penguins` dataset!
  - Render it with the Render button!
...
- Explore the navigation options
- Turn Visual Editor mode on/off and explore the sections
- Render the document and find the broken code, then fix it and render again!
